...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Boom Demo Installer\n"
      else:
        line="OutputBaseFilename=Boom Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Boom Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Boom installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Boom Demo installer\n"
     else:
       line="SetupWindowTitle=Boom installer\n"
