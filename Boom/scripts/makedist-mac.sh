...
NOTARIZE_BUNDLE_ID=com.TwoBitVision.Boom
NOTARIZE_BUNDLE_ID_DEMO=com.TwoBitVision.Boom.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Boom.iss
#  git checkout installer/Boom.pkgproj
